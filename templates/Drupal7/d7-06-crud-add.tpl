...
function <<$tablename_clean_singular>>_add($form, &$form_state) {
  ...
  $form['description'] = array(
    '#type' => 'item',
    '#title' => t('Add a new <<$tablename_clean_singular|replace:'_':' '|capitalize>>'),
  );
...
function <<$tablename_clean_singular>>_add_submit($form, &$form_state) {
  ...
  #$<<$tablename_clean_singular>>->user_id = get_user_id();
...
<</section>>
  ...
  #drupal_set_message(t('The new <<$tablename_clean_singular|capitalize>> has been added.'));
